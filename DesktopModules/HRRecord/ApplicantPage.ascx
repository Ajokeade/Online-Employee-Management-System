<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ApplicantPage.ascx.cs" Inherits="Bilikis.HRManagementSystem.ApplicantPage" %>
...
<table style="width:100%;">
    <tr>
        <td style="width: 150px" valign="top"> <table style="width: 100%;">
             ...
             <tr>
                    <td>
                        <asp:Button ID="Button11" runat="server" Font-Bold="True" ForeColor="#CC3300" Height="35px" Text="Continue Application" Width="150px" OnClick="Button11_Click" style="font-size: small" />
                    </td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="Button4" runat="server" Font-Bold="True" ForeColor="#CC3300" Height="35px" Text="Biodata" Width="150px" OnClick="Button4_Click" style="font-size: medium" Visible="False" />
                    </td>
                    
                </tr>
                <tr>
                    <td>
                        <asp:Button ID="Button5" runat="server" Font-Bold="True" ForeColor="#CC3300" Height="35px" Text="Qualification" Width="150px" OnClick="Button5_Click" style="font-size: medium" Visible="False" />
                    </td>
                    
                </tr>
             <tr>
                    <td>
                        <asp:Button ID="Button6" runat="server" Font-Bold="True" ForeColor="#CC3300" Height="35px" Text="Professional Cert" Width="150px" OnClick="Button6_Click" style="font-size: medium" Visible="False" />
                    </td>
                    
                </tr>
             <tr>
                    <td>
                        <asp:Button ID="Button7" runat="server" Font-Bold="True" ForeColor="#CC3300" Height="35px" Text="Work Experience" Width="150px" OnClick="Button7_Click" style="font-size: medium" Visible="False" />
                    </td>
                    
                </tr>
             <tr>
                    <td>
                        <asp:Button ID="Button8" runat="server" Font-Bold="True" ForeColor="#CC3300" Height="35px" Text="Document" Width="150px" OnClick="Button8_Click" style="font-size: medium" Visible="False" />
                    </td>
...
<asp:MultiView ID="MViewApplicant" runat="server">
    <asp:View ID="homepage" runat="server">
        <table style="border-style: solid; border-color: #CC3300; width:100%;">
            ...
            <tr>
                <td>
                    <p>
                        You are expected to provide the following details when applying for any of the position&nbsp; </p>
    ...
    <tr>
        <td class="auto-style30" colspan="5">
            &nbsp;<asp:Label ID="LbAppInfo" runat="server" Font-Bold="True" Font-Size="14pt" ForeColor="#CC0066" Text="Applicant Personal Information " style="color: #CC3300; font-style: italic"></asp:Label>
        </td>
    </tr>
            <tr>
        ...
        --%></td>
            ...
            <tr>
                <td class="auto-style30">&nbsp;</td>
                <td class="auto-style74">
                    <asp:Label ID="Label21" runat="server" style="font-weight: 700" Text="Title"></asp:Label>
                </td>
                <td class="auto-style26">
     ...
     <tr>
        ...
        <td class="auto-style21">&nbsp;</td>
            ...
            <tr>
                <td class="auto-style30">&nbsp;</td>
                <td class="auto-style74">
                    <asp:Label ID="Label22" runat="server" style="font-weight: 700" Text="Religion"></asp:Label>
                </td>
                <td class="auto-style26">
                    <asp:DropDownList ID="ddlReligion" runat="server" Width="351px">
                        <asp:ListItem>---Please Select--</asp:ListItem>
     ...
     <tr>
        ...
        <td class="auto-style18">
           ...
           <td>&nbsp;</td>
            ...
            <tr>
                <td class="auto-style30">&nbsp;</td>
                <td class="auto-style74">&nbsp;<asp:Label ID="LbEmail" runat="server" Font-Bold="True" Font-Size="14pt" style="font-size: medium" Text="Email"></asp:Label>
                </td>
                <td class="auto-style26">
    ...
    <tr>
        ...
        <td class="auto-style21">&nbsp;</td>
            ...
            <tr>
                <td class="auto-style30">&nbsp;</td>
                <td class="auto-style74">
                    <asp:Label ID="LbDOB1" runat="server" Font-Bold="True" Font-Size="14pt" style="font-size: medium" Text="DOB"></asp:Label>
                </td>
                <td class="auto-style26">
    ...
    <tr>
        ...
        <td class="auto-style21">&nbsp;</td>
            ...
            <tr>
                ...
                <td class="auto-style28">
                    <asp:Label ID="lblinvalidPicture" runat="server" style="color: #CC3300; font-weight: 700"></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style5">&nbsp;</td>
                <td class="auto-style28">
                    <asp:Image ID="Image1" runat="server" BorderColor="#CC3300" BorderWidth="3px" Height="179px" Width="170px" />
                    ...
                    <br />
                    &nbsp;&nbsp;
                    <asp:Button ID="passportUploadBtn" runat="server" Font-Bold="True" ForeColor="#33CC33" OnClick="passportUploadBtn_Click" style="color: #CC3300" Text="Upload" />
                </td>
            ...
            <tr>
                ...
                <td class="auto-style74">&nbsp;</td>
                <td class="auto-style26">
                    <asp:Button ID="ApplicantNextBtn" runat="server" Font-Bold="True" Font-Size="14pt" ForeColor="#33CC33" OnClick="applicantNextBtn_Click" style="font-size: medium; color: #CC3300;" Text="Next" Enabled="False" />
                </td>
                <td class="auto-style18">&nbsp;</td>
                <td class="auto-style21">&nbsp;</td>
            </tr>
        ...
        <td class="auto-style30">&nbsp;</td>
        <td class="auto-style74">
            <asp:Label ID="lblNotVisibleApplicantNum" runat="server"></asp:Label>
                     </td>
        <td class="auto-style26">
&nbsp;</td>
        <td class="auto-style18">&nbsp;</td>
        ...
        <table style="border: medium solid #CC3300; width:100%;">
            ...
            <tr>
             ...
             <tr>
                ...
                <td class="auto-style12">
                    <asp:DropDownList ID="qualifList" runat="server" AutoPostBack="True" Height="16px" OnSelectedIndexChanged="qualifList_SelectedIndexChanged" Width="311px">
                    </asp:DropDownList>
                 </td>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td class="auto-style31">&nbsp;</td>
                <td class="auto-style8">
                    <asp:Label ID="LbCourse" runat="server" Font-Bold="True" Font-Size="14pt" style="font-size: medium" Text="Course"></asp:Label>
                </td>
                <td class="auto-style12">
                    <asp:DropDownList ID="courseList" runat="server" Height="16px" Width="311px">
                        ...
                        <asp:ListItem>EDucation Science</asp:ListItem>
            ...
            <tr>
             ...
             <tr>
                <td class="auto-style31">&nbsp;</td>
                <td class="auto-style8">
                    <asp:Button ID="qualifAddBtn" runat="server" Font-Bold="True" Font-Size="14pt" ForeColor="#33CC33" OnClick="qualifAddBtn_Click1" style="font-size: medium; color: #CC3300;" Text="Add" />
                 </td>
                <td class="auto-style12">
            ...
            <tr>
                <td colspan="4">
                    <asp:GridView ID="GViewQualif" runat="server" AutoGenerateColumns="False" CellPadding="4" EnableModelValidation="True" ForeColor="#333333" GridLines="None" Height="117px" Visible="False" OnRowCommand="GViewQualif_RowCommand" OnRowDeleting="GViewQualif_RowDeleting" >
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.QualificationID") %>'></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <td colspan="4">
                    <asp:GridView ID="GViewCert" runat="server" AutoGenerateColumns="False" CellPadding="4" EnableModelValidation="True" ForeColor="#333333" GridLines="None"   Visible="False" OnRowCommand="GViewCert_RowCommand" OnRowDeleting="GViewCert_RowDeleting">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.ProfQualificationID") %>'></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                  ...
                  <td colspan="4">
                      <asp:GridView ID="GViewWorkExp" runat="server" AutoGenerateColumns="False" CellPadding="4" EnableModelValidation="True" ForeColor="#333333" GridLines="None" Visible="False" OnRowCommand="GViewWorkExp_RowCommand" OnRowDeleting="GViewWorkExp_RowDeleting" >
                          ...
                          <Columns>
                              ...
                              <asp:TemplateField ShowHeader="False">
                                  <ItemTemplate>
                                      <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" CommandArgument='<%#DataBinder.Eval(Container,"DataItem.WorkExperienceID")%>'></asp:LinkButton>
                                  </ItemTemplate>
                              </asp:TemplateField>
                          </Columns>
                          <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
        ...
        <table style="border: medium solid #CC3300; width:100%;">
            ...
            <tr>
                <td class="auto-style13" colspan="4">
                    &nbsp;&nbsp;<asp:GridView ID="GViewDoc" runat="server" AutoGenerateColumns="False" CellPadding="4" EnableModelValidation="True" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GViewDoc_SelectedIndexChanged" OnRowCommand="GViewDoc_RowCommand" OnRowDeleting="GViewDoc_RowDeleting">
                        <AlternatingRowStyle BackColor="White" />
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" CommandArgument='<%#DataBinder.Eval(Container,"DataItem.DocumentID") %>'></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                ...
                <td colspan="4">
                    <table style="width: 80%;  margin-left:75px; ">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td class="auto-style50"><strong>Applicant Num</strong></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style84">
                                <asp:Label ID="lbltitle" runat="server" style="color: #CC3300; font-weight: 700" Text="Label"></asp:Label>
                            </td>
                            <td>&nbsp;</td>
                            <td class="auto-style50">&nbsp;</td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td class="auto-style50"><strong>State of Origin</strong></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td class="auto-style50"><strong>LGA</strong></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td class="auto-style50"><strong>Home Town</strong></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td class="auto-style50"><strong>Email</strong></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td class="auto-style50"><strong>PhoneNo</strong></td>
                            <td>
                        ...
                        <tr>
                            <td class="auto-style89"><strong>Age</strong></td>
                            <td class="auto-style53">
                                <asp:Label ID="lblAge" runat="server" style="font-weight: 700; color: #CC3300;" Text="Label"></asp:Label>
                            </td>
                            <td class="auto-style52"></td>
                            <td class="auto-style54"><strong>ContactAddress</strong></td>
                            <td class="auto-style52">
                        ...
                        <tr>
                            <td class="auto-style85"><strong>Religion</strong></td>
                            <td class="auto-style84">
                ...
                <td colspan="3">
                    <table style="width: 75%; margin-left:90px">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="Button12" runat="server" Height="24px" OnClick="Button12_Click" style="font-weight: 700" Text="Continue" />
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                    </table>
    ...
    <tr>
        <td>&nbsp;</td>
        <td>
            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click" Visible="False">Home</asp:LinkButton>
&nbsp;
            <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LinkButton4_Click" Visible="False">Biodata</asp:LinkButton>
&nbsp;&nbsp;
            <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click" Visible="False">Qualification</asp:LinkButton>
&nbsp;&nbsp;
            <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton6_Click" Visible="False">Professional Qualification </asp:LinkButton>
&nbsp;
            <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LinkButton7_Click" Visible="False">Work Experience</asp:LinkButton>
&nbsp;
            <asp:LinkButton ID="LinkButton8" runat="server" OnClick="LinkButton8_Click" Visible="False">Documents</asp:LinkButton>
&nbsp;&nbsp;
            <asp:LinkButton ID="LinkButton9" runat="server" OnClick="LinkButton9_Click" Visible="False">Summary</asp:LinkButton>
        </td>
    </tr>
</table>
